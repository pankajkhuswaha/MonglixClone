...
//         <svg
//           class="w-1/2 md:w-1/3 lg:w-1/4 text-blue-600"
...
//             500
//           </p>
//           <p class="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-600 mt-2">
//             Server Error
//           </p>
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center">
        <p className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider text-[#FF4268] mt-8">
          500
        </p>
        <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#FF4268] mt-2">
          Server Error
        </p>
