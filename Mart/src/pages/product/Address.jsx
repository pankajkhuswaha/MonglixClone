          ...
          <div className=" border text-dark p-4 rounded shadow">
            ...
            <div className="space-y-2">
              <div className="flex gap-2 mb-4 justify-center">
                <input
                  className="border-[1px] w-full  border-gray-500 rounded-md p-2 text-md text-gray-600 font-semibold "
                  type="text"
                  onFocus={(e) => (e.target.style.outline = "none")}
                  placeholder="Apply Discount Coupon"
                />
                <Buttonele title={"submit"} />
              </div>
              <div className="flex justify-between font-semibold">
                <p>SubTotal:</p>
                <p className="text-gray-800">
                  {numberFormat(carts.totalProductPrice)}{" "}
                </p>
              </div>
              <div className="flex justify-between text-md  font-semibold">
                <p>Discount:</p>
                <p className="text-gray-800" style={{ fontWeight: "semibold" }}>
                  {numberFormat(carts.totalProductPrice - carts.totalCartValue)}
                </p>
              </div>
              <div className="flex justify-between  font-semibold">
                <p>Total Payable:</p>
